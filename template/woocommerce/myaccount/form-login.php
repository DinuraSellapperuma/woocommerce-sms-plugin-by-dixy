...
<?php endif; ?>
    ...
    <?php endif; ?>
		...
		<form id="sms_panel_email_login_form" class="woocommerce-form woocommerce-form-login login" method="post">
    ...
    <?php if (get_option('sms_panel_enable_login_with_phone_number') && get_option('sms_panel_enable_login_with_phone_number')[0]) : ?>
      <form id="sms_panel_phone_login_form" class="woocommerce-form woocommerce-form-login login">
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
    ...
    <?php if (get_option('sms_panel_enable_register_with_phone_number') && get_option('sms_panel_enable_register_with_phone_number')[0]) : ?>
      <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
    ...
    <?php endif; ?>
		...
		<form id="sms_panel_email_register_form" method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
    ...
    <?php if (get_option('sms_panel_enable_register_with_phone_number') && get_option('sms_panel_enable_register_with_phone_number')[0]) : ?>
      <form id="sms_panel_phone_register_form" class="woocommerce-form woocommerce-form-register register d-none">
        ...
        <p id="sms_panel_register_phone_field" class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
					<label for="sms_panel_register_phone"><?php esc_html_e( 'Phone', 'sms_panel' ); ?>&nbsp;<span class="required">*</span></label>
        ...
        <?php wp_nonce_field( 'register_user_otp', 'sms-panel-register-nonce' ); ?>
      </form>
    <?php endif; ?>
